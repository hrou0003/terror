...
pub struct Torrent {
    // URL to a "tracker", which is a central server that keeps track of peers participating in the sharing of a torrent_info.
    pub announce: String,
...
pub struct Info {
    ...
    // list of files in a multi-file torrent_info
    #[serde(default)]
    #[serde(skip_serializing_if = "Option::is_none")]
